...
4. **Python environment** with Margos dependencies
...
sed -e "s|MARGOS_CONTROLLER_LIB|$CONTROLLER_LIB|g" \
    -e "s|MARGOS_LOOP_LIB|$LOOP_LIB|g" \
...
from margos.argos_zoo.scenarios.aggregation import aggregation_reward
